...
public class TestApp {
	...
	public static void main(String[] args) throws IOException {
		...
		ProgrammerProjId proj= new ProgrammerProjId(101,5001);
		boolean flag=false;
		
		try {
			  
			  ProgrammerProjectInfo projInfo= new ProgrammerProjectInfo(proj,"Nikhil","ECE","SchoolPortal");
			  session.find(ProgrammerProjectInfo.class,projInfo);
			  flag=true;
		}catch(Exception e) {
			  flag=false;
			  e.printStackTrace();
